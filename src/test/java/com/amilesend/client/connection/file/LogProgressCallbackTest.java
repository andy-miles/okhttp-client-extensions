...
public class LogProgressCallbackTest {
    ...
    @Test
    public void formatPrefix_withSourceAndDestination_shouldReturnPrefix() {
        final String expected = "[SourceValue -> DestinationValue] ";

        final String actual = LogProgressCallback.formatPrefix("SourceValue", "DestinationValue");

        assertEquals(expected, actual);
    }

    @Test
    public void formatPrefix_withInvalidInput_shouldThrowException() {
        assertAll(
                () -> assertThrows(NullPointerException.class,
                        () -> LogProgressCallback.formatPrefix(null, "DestinationValue")),
                () -> assertThrows(IllegalArgumentException.class,
                        () -> LogProgressCallback.formatPrefix(StringUtils.EMPTY, "DestinationValue")),
                () -> assertThrows(NullPointerException.class,
                        () -> LogProgressCallback.formatPrefix("SourceValue", null)),
                () -> assertThrows(IllegalArgumentException.class,
                        () -> LogProgressCallback.formatPrefix("SourceValue", StringUtils.EMPTY)));
    }
}
